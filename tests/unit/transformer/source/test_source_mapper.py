        ...
        config_dict = {
            ...
            'source': {
                ...
                'footer': {
                    ...
                    'format': [{'name': 'footer1', 'spec': '0,5'}],
                },
            },
        }
        file_data = {
            'header': {'values': [['12']], 'spacing': [4]},
            'body': {'values': [['10'], ['11'], ['12']], 'spacing': [10]},
            'footer': {'values': [['1X']], 'spacing': [5]},
        }
